...
echo "Reverse proxy at port 9000 (to see it sudo cat /etc/nginx/sites-enabled/reverse-proxy.conf)"
echo "If the certificate does not work, run sudo certbot renew"
